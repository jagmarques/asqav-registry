...
export const REQUEST_EXTRA_TYPES = [
  "authoritative"
] as const;
...
export const CAPTURE_TOPOLOGIES = [
  "in_process_sdk",
  "network_proxy",
  "browser_extension",
  "mcp_proxy",
...
export const STANDARD_RISK_CLASSES = [
  "low",
  "medium",
  "high",
  "unknown"
...
export const DORA_INCIDENT_CLASSES = [
...
export const HIPAA_INCIDENT_CLASSES = [
  "hipaa_security_incident"
] as const;

export const RECEIPT_PROFILE = [
  "protectmcp:decision",
  "protectmcp:restraint",
  "protectmcp:lifecycle",
  "protectmcp:lifecycle:configuration_change",
...
export type CaptureTopology = (typeof CAPTURE_TOPOLOGIES)[number];
